...
def extract_cve_base_score(json_response):
    try:
        base_score = float(json_response["result"]["CVE_Items"][0]["impact"]["baseMetricV2"]["cvssV2"]["baseScore"])
    except:
        base_score = -1.0
    return base_score
...
def extract_cve_cvssv3_string(json_response):
    try:
        cvssv3_string = json_response["result"]["CVE_Items"][0]["impact"]["baseMetricV2"]["cvssV2"]["vectorString"]
    except:
        cvssv3_string = "N/A"
